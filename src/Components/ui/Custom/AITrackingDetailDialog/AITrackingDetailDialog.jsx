  ...
  return (
    <div className="group flex items-start gap-4 py-3 hover:bg-gradient-to-r hover:from-slate-50/50 hover:to-transparent dark:hover:from-slate-800/30 dark:hover:to-transparent rounded-lg transition-all duration-200 px-2 -mx-2">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className={`text-sm font-medium leading-relaxed ${className}`}>
          {value}
        </div>
      </div>
    </div>
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[95vw] sm:max-w-3xl max-h-[85vh] overflow-y-auto scrollbar-hide px-4 sm:px-6 bg-gradient-to-br from-white via-slate-50/80 to-purple-50/60 dark:from-slate-900 dark:via-slate-800/95 dark:to-slate-900/95 backdrop-blur-xl border border-purple-200/50 dark:border-slate-700/60 shadow-2xl ring-1 ring-white/20 dark:ring-white/10 data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:slide-in-from-bottom-4 data-[state=open]:zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:slide-out-to-bottom-4 data-[state=closed]:zoom-out-95 duration-300">
        ...
        <DialogHeader className="relative z-10 pb-6 border-b border-purple-200/30 dark:border-slate-700/40">
          <div className="flex items-start gap-3 mb-2">
            ...
            <div className="flex-1">
              <DialogTitle className="text-xl font-bold bg-gradient-to-r from-slate-800 via-slate-700 to-slate-800 dark:from-slate-100 dark:via-slate-200 dark:to-slate-100 bg-clip-text text-transparent leading-tight">
                {item.title}
              </DialogTitle>
        ...
        <div className="relative z-10 space-y-1 py-6">
          ...
          {item.prompt && (
            <div className="py-3">
              <div className="group flex items-start gap-4 hover:bg-gradient-to-r hover:from-slate-50/50 hover:to-transparent dark:hover:from-slate-800/30 dark:hover:to-transparent rounded-lg transition-all duration-200 px-2 -mx-2">
                <div className="flex-shrink-0 mt-1 p-1.5 rounded-lg bg-gradient-to-br from-purple-100 to-pink-100 dark:from-purple-900/40 dark:to-pink-900/40 group-hover:scale-110 transition-transform duration-200">
                  <AlignLeft size={16} className="text-purple-600 dark:text-purple-400" />
                </div>
                <div className="flex-1">
                  <div className="text-xs font-medium text-slate-500 dark:text-slate-400 mb-2 uppercase tracking-wide">
                    Prompt
                  </div>
                  <div className="text-sm bg-gradient-to-r from-slate-100/90 to-slate-50/90 dark:from-slate-800/90 dark:to-slate-700/90 backdrop-blur-sm p-4 rounded-xl border border-slate-200/50 dark:border-slate-600/30 whitespace-pre-wrap leading-relaxed text-slate-700 dark:text-slate-300 shadow-sm">
                    {item.prompt}
                  </div>
                </div>
              </div>
          ...
          {sources.length > 0 && (
            <div className="py-3">
              <div className="group flex items-start gap-4 hover:bg-gradient-to-r hover:from-slate-50/50 hover:to-transparent dark:hover:from-slate-800/30 dark:hover:to-transparent rounded-lg transition-all duration-200 px-2 -mx-2">
                <div className="flex-shrink-0 mt-1 p-1.5 rounded-lg bg-gradient-to-br from-blue-100 to-indigo-100 dark:from-blue-900/40 dark:to-indigo-900/40 group-hover:scale-110 transition-transform duration-200">
          ...
          {item.status === 'failed' && (
            <div className="py-3">
              <div className="group flex items-start gap-4 px-2 -mx-2">
                <div className="flex-shrink-0 mt-1 p-1.5 rounded-lg bg-gradient-to-br from-red-100 to-orange-100 dark:from-red-900/40 dark:to-orange-900/40">
                ...
                <div className="flex-1">
                  ...
                  <div className="bg-gradient-to-r from-red-50 to-orange-50 dark:from-red-950/30 dark:to-orange-950/20 p-4 rounded-xl border border-red-200/70 dark:border-red-900/50 shadow-sm">
