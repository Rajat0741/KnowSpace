import { SIDEBAR_COOKIE_NAME, SIDEBAR_COOKIE_MAX_AGE, SIDEBAR_WIDTH, SIDEBAR_WIDTH_MOBILE, SIDEBAR_WIDTH_ICON, SIDEBAR_KEYBOARD_SHORTCUT, SidebarContext, useSidebarContext} from "./sidebar-utils";
  ...
  return (
    <main
      ...
      className={cn(
        ...
        // Inset variant behavior
        "md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2",
        // Floating variant behavior - similar to inset but without margin
        "md:peer-data-[variant=floating]:ml-0",
        // Default sidebar variant behavior
