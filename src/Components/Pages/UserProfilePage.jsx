            ...
            <div className='min-h-screen relative overflow-hidden'>
                ...
                <div className='relative z-10 container mx-auto px-4 py-8 space-y-8'>
                    <div className='max-w-4xl mx-auto space-y-8'>
                        ...
                        {/* Hero skeleton */}
                        <div className='bg-white/60 dark:bg-gray-900/60 backdrop-blur-xl border border-blue-200/20 dark:border-purple-800/20 rounded-2xl shadow-xl p-8'>
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
                            {[...Array(3)].map((_, i) => (
                                <div key={i} className='bg-white/60 dark:bg-gray-900/60 backdrop-blur-xl border border-blue-200/20 dark:border-purple-800/20 rounded-xl p-6 animate-pulse'>
    ...
    if (error) {
        return (
            <div className='min-h-screen relative overflow-hidden flex items-center justify-center'>
                {/* Enhanced Background */}
                <div className="fixed inset-0 -z-10">
                    <div className="absolute inset-0 bg-gradient-to-br from-red-50/40 via-orange-50/30 to-pink-50/40 dark:from-red-950/30 dark:via-orange-950/20 dark:to-pink-950/30" />
                    <div className="absolute inset-0 bg-gradient-to-t from-white/60 via-transparent to-transparent dark:from-gray-900/60" />
                    <div className="absolute top-0 left-0 w-full h-full opacity-20 dark:opacity-15">
                        <div className="absolute top-32 left-16 w-64 h-64 bg-red-400/15 rounded-full blur-3xl animate-pulse"></div>
                        <div className="absolute top-20 right-20 w-80 h-80 bg-orange-400/15 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1.5s' }}></div>
                        <div className="absolute bottom-32 left-1/2 w-72 h-72 bg-pink-400/15 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '3s' }}></div>
                    </div>
                </div>

                <div className='relative z-10 text-center p-8'>
                    <div className='bg-white/60 dark:bg-gray-900/60 backdrop-blur-xl border border-red-200/20 dark:border-red-800/20 rounded-2xl shadow-xl p-8 max-w-md'>
                        ...
                        <Link
                            to="/search"
                            className='inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-600 hover:to-pink-600 text-white font-medium rounded-xl transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl'
                        >
    ...
    return (
        <div className='min-h-screen relative overflow-hidden'>
            ...
            <div className='relative z-10 container mx-auto px-4 py-8 space-y-8'>
                    ...
                    {/* User Profile Card */}
                    <div className='bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border border-slate-200/60 dark:border-slate-700/50 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300'>
                        
                        {/* Header with gradient */}
                        <div className='relative bg-slate-50/50 dark:bg-slate-800/50 p-8 border-b border-slate-200/50 dark:border-slate-700/40 rounded-t-xl'>
                            <div className='relative flex flex-col md:flex-row items-center md:items-start gap-6'>
                                ...
                                <div className='relative group'>
                                    <ProfilePicture
                                        size="3xl"
                                        className="shadow-lg ring-4 ring-white/60 dark:ring-slate-700/60 transition-all duration-300 group-hover:ring-blue-400/60 group-hover:shadow-blue-400/20 group-hover:shadow-xl"
                                ...
                                <div className='flex-1 text-center md:text-left space-y-4'>
                                    ...
                                    {/* Bio */}
                                    {userBio && (
                                        <div className='bg-white/60 dark:bg-slate-800/60 rounded-xl p-4 shadow-md border border-slate-200/50 dark:border-slate-600/40'>
                                    ...
                                    <div className='flex flex-wrap justify-center md:justify-start gap-4 text-sm text-slate-600 dark:text-slate-400'>
                                        {userRegistrationDate && (
                                            <div className='flex items-center gap-2 bg-white/60 dark:bg-slate-800/60 px-3 py-2 rounded-lg border border-slate-200/50 dark:border-slate-600/40'>
                        ...
                        <div className='p-8'>
                            ...
                            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                                {/* Member since */}
                                {userRegistrationDate && (
                                    <div className='bg-white/60 dark:bg-slate-800/60 rounded-xl p-5 space-y-3 shadow-md border border-slate-200/50 dark:border-slate-600/40'>
                ...
                <div className='relative bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border border-slate-200/60 dark:border-slate-700/50 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300'>
                    ...
                    <div className='bg-blue-50/80 dark:bg-blue-950/50 backdrop-blur-xl border border-blue-200/60 dark:border-blue-700/50 rounded-xl p-6 shadow-md'>
                        <div className='flex items-start gap-3'>
                            <div className='p-2 bg-blue-500 rounded-lg shadow-sm'>
                                <User className='w-4 h-4 text-white' />
                            </div>
                            <div>
                                <h3 className='font-semibold text-blue-800 dark:text-blue-200 mb-1'>Public Profile</h3>
