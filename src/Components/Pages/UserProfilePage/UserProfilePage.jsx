...
function UserProfilePage() {
        ...
        return (
            <div className='min-h-screen relative overflow-hidden'>
                ...
                <div className="fixed inset-0 -z-10">
                    <div className="absolute inset-0 bg-gradient-to-br from-cyan-50/40 via-teal-50/30 to-blue-50/40 dark:from-slate-900/30 dark:via-slate-800/20 dark:to-slate-900/30" />
                    ...
                    <div className="absolute top-0 left-0 w-full h-full opacity-20 dark:opacity-15">
                        <div className="absolute top-32 left-16 w-64 h-64 bg-cyan-400/15 dark:bg-slate-700/25 rounded-full blur-3xl animate-pulse"></div>
                        <div className="absolute top-20 right-20 w-80 h-80 bg-teal-400/15 dark:bg-slate-600/25 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1.5s' }}></div>
                        <div className="absolute bottom-32 left-1/2 w-72 h-72 bg-blue-400/15 dark:bg-slate-700/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '3s' }}></div>
                        <div className="absolute top-1/2 right-1/4 w-48 h-48 bg-cyan-400/15 dark:bg-slate-800/25 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '4.5s' }}></div>
                    </div>
                </div>
                ...
                <div className='relative z-10 container mx-auto px-4 py-8 space-y-8'>
                    <div className='max-w-4xl mx-auto space-y-8'>
                        ...
                        {/* Hero skeleton */}
                        <div className='bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl border border-cyan-200/30 dark:border-slate-700/50 rounded-2xl shadow-xl p-8'>
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
                            {[...Array(3)].map((_, i) => (
                                <div key={i} className='bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl border border-cyan-200/30 dark:border-slate-700/50 rounded-xl p-6 animate-pulse'>
            ...
            <div className='min-h-screen relative overflow-hidden flex items-center justify-center'>
                ...
                <div className='relative z-10 text-center p-8'>
                    <div className='bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl border border-red-200/30 dark:border-slate-700/50 rounded-2xl shadow-xl p-8 max-w-md'>
                        ...
                        <Link
                            to="/search"
                            className='inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-teal-500 to-cyan-500 hover:from-teal-600 hover:to-cyan-600 text-white font-medium rounded-xl transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl'
                        >
    ...
    return (
        <div className='min-h-screen relative overflow-hidden'>
            {/* Background */}
            <div className="absolute inset-0 bg-gradient-to-br from-slate-50/50 via-cyan-50/30 to-teal-50/20 dark:from-slate-900/50 dark:via-slate-800/30 dark:to-slate-900/20">
                <div className="absolute top-1/3 left-1/3 w-96 h-96 bg-cyan-500/5 dark:bg-slate-700/20 rounded-full blur-3xl" />
                <div className="absolute bottom-1/3 right-1/3 w-80 h-80 bg-teal-500/5 dark:bg-slate-600/20 rounded-full blur-3xl" />
            </div>
            ...
            <div className='relative z-10 container mx-auto px-4 py-8 space-y-8'>
                    ...
                    {/* User Profile Card */}
                    <div className='bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border border-cyan-200/40 dark:border-slate-700/50 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300'>
                        
                        {/* Header with gradient */}
                        <div className='relative bg-gradient-to-br from-slate-50/80 via-cyan-50/40 to-teal-50/30 dark:from-slate-800/80 dark:via-slate-800/60 dark:to-slate-800/50 p-8 border-b border-cyan-200/30 dark:border-slate-700/40 rounded-t-xl'>
                            <div className='relative flex flex-col md:flex-row items-center md:items-start gap-6'>
                                ...
                                <div className='relative group'>
                                    <ProfilePicture
                                        size="3xl"
                                        className="shadow-lg ring-4 ring-white/60 dark:ring-slate-700/60 transition-all duration-300 group-hover:ring-teal-400/60 group-hover:shadow-teal-400/20 group-hover:shadow-xl"
                                ...
                                <div className='flex-1 text-center md:text-left space-y-4'>
                                    ...
                                    {/* Bio */}
                                    {userBio && (
                                        <div className='bg-white/70 dark:bg-slate-800/70 rounded-xl p-4 shadow-md border border-cyan-200/40 dark:border-slate-600/40'>
                                            <div className='flex items-start gap-3'>
                                                <div className='p-2 bg-gradient-to-br from-teal-500 to-cyan-600 rounded-lg shadow-sm flex-shrink-0'>
                                    ...
                                    <div className='flex flex-wrap justify-center md:justify-start gap-4 text-sm text-slate-600 dark:text-slate-400'>
                                        {userRegistrationDate && (
                                            <div className='flex items-center gap-2 bg-white/70 dark:bg-slate-800/70 px-3 py-2 rounded-lg border border-cyan-200/40 dark:border-slate-600/40'>
                        ...
                        <div className='p-8'>
                            ...
                            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                                {/* Member since */}
                                {userRegistrationDate && (
                                    <div className='bg-white/70 dark:bg-slate-800/70 rounded-xl p-5 space-y-3 shadow-md border border-cyan-200/40 dark:border-slate-600/40'>
                    ...
                    {/* Posts Section */}
                <div className='relative bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border border-cyan-200/40 dark:border-slate-700/50 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300'>

                    <div className='relative p-8 border-b border-cyan-200/30 dark:border-slate-700/40 bg-gradient-to-br from-slate-50/80 via-cyan-50/40 to-teal-50/30 dark:from-slate-800/80 dark:via-slate-800/60 dark:to-slate-800/50 rounded-t-xl'>
                    ...
                    <div className='relative p-10'>
                        ...
                        {postsLoading ? (
                            ...
                            <div className='flex flex-col items-center justify-center py-20 px-6 text-center'>
                                <div className='relative bg-gradient-to-br from-slate-50/80 via-cyan-50/40 to-teal-50/30 dark:from-slate-800/80 dark:via-slate-800/60 dark:to-slate-800/50 rounded-2xl p-12 max-w-lg shadow-lg border border-cyan-200/30 dark:border-slate-600/40 overflow-hidden'>
                    ...
                    <div className='bg-teal-50/80 dark:bg-slate-800/80 backdrop-blur-xl border border-teal-200/60 dark:border-slate-700/50 rounded-xl p-6 shadow-md'>
                        <div className='flex items-start gap-3'>
                            <div className='p-2 bg-teal-500 rounded-lg shadow-sm'>
                                <User className='w-4 h-4 text-white' />
                            </div>
                            <div>
                                <h3 className='font-semibold text-teal-800 dark:text-teal-200 mb-1'>Public Profile</h3>
